...
SECRET_KEY = 'django-insecure-syh4bm09u091s@u*b0^rp+i@pow(h*4(83-_l54v#z!9hh+97d'
...
INSTALLED_APPS = [
    ...
    # My apps:
    'tasks',  # <--- Add this line for your tasks app
    # Third-party apps:
    'rest_framework',  # <--- Add this for Django REST Framework
    'rest_framework.authtoken',
    'django_filters',  # <--- Add this for filtering API results
    'corsheaders',     # <--- Add this for Cross-Origin Resource Sharing (for frontend)
]
...
DATABASES = {
    'default': {
        ...
        'USER': 'task_manager_user',                       # Your database username
        'PASSWORD': 'your_very_secure_password',           # Your database password
